<div class="section__content section__content--p30">
    <div class="container-fluid">
        <!-- DATA TABLE -->
        <h3 class="title-5 m-b-35">Liste de tous les commentaires</h3>
                ...
                <tbody class="comment-list">
                    ...
                    foreach ($data['commentlist'] as $key => $comment) {
                        if (is_int($key)) {
                            ...
                            if ($comment['status'] == 0)
                                echo        '<a href="#validate-comment?getAllComments()" class="item" data-toggle="modal" data-target="#staticBackdrop" title="Valider"><i class="zmdi zmdi-check"></i></a>';
